                            ...
                            <form action="{{url('edit_category')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" name="id" value="{{$category->id}}" class="form-control" hidden  placeholder="">
                                        <input required type="text" name="name" value="{{$category->name}}" class="form-control"  placeholder="اسم التصنيف">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">وصف</label>
                                        <textarea required name="description" class="form-control">{{$category->description}}</textarea>
                                    </div>
                                    <div class="form-group">
