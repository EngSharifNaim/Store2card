...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h2>إضافة مدير فرعي جديد</h2>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{url('masters')}}">قائمة المدراء</a></li>
                        <li class="breadcrumb-item active">إضافة مدير فرعي جديد</li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="admin_form" action="{{url('api/create_master')}}" method="post">
                            @csrf
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <button type="button" onclick="create_master()" class="btn btn-primary">حفظ <i class="nav-icon fa fa-send"></i></button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
