            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id=user_form" action="{{url('products/update')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                @if(isset($message))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="text" hidden required name="product_id" value="{{$product->id}}" class="form-control" placeholder="اسم المنتج">
                                            <input type="text" required name="name" value="{{$product->name}}" class="form-control" placeholder="اسم المنتج">
                                        </div>
                                        <div class="col-2">
                                            <input type="number" required name="price" value="{{$product->price}}" class="form-control" placeholder="سعر المنتج">
                                        </div>
                                    ...
                                    <div class="form-group" style="align-content: center">
                                        <img class="profile-user-img img-fluid img-circle" @if($product->image != NULL) src="{{url('images/products/' . $product->image)}}" @else src="{{url('images/noimage.png')}}" @endif alt="User profile picture">
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" @if($product->offer == 1) checked @endif name="offer" class="form-check-input" id="exampleCheck1">
