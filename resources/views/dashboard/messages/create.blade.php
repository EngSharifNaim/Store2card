                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">بيانات الزبون</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <div class="direct-chat-msg right">
                        <form id=user_form" action="{{url('api/create_market')}}" method="post">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <input type="text" required name="name" class="form-control" placeholder="اسم الزبون">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="text" required name="address" class="form-control" placeholder="العنوان">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <input type="text" required name="mobile" class="form-control" placeholder="رقم الجوال">
                                        </div>
                                        <div class="col-4">
                                            <input type="text" required name="email" class="form-control" placeholder="الايميل">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="button" onclick="create_user()" class="btn btn-primary">حفظ <i class="nav-icon fa fa-send"></i></button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
