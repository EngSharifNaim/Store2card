...
<header id="header" class="row">
    ...
    <div class="header-logo" style="padding-top: 30px">
        <a href="index.html">Store2Card</a>
    </div>
...
<!-- home
================================================== -->
<section id="home" data-parallax="scroll" data-image-src="{{url('images/hero-bg.jpg')}}" data-natural-width=3000 data-natural-height=2000>
    ...
    <div class="home-content">
        ...
        <div class="row contents">
            <div class="home-content-left">
                ...
                <h3 data-aos="fade-up">Welcome to Store2Card</h3>

                <h1 data-aos="fade-up">
                    By Cards <br>
                    Get reseller acount <br>
                    Your Amazing App.
                </h1>
            ...
            <div class="home-image-right">
                <img src="{{url('images/iphone-app-470.png')}}"
                     srcset="{{url('images/iphone-app-470.png')}} 1x, {{url('images/iphone-app-940.png')}} 2x"
                     data-aos="fade-up">
            </div>
        </div>
...
<section id="about">
    ...
    <div class="row about-bottom-image">
        ...
        <img src="{{url('images/app-screens-1200.png')}}"
            ...
            <div class="slides owl-carousel">
                ...
                <div>
                    ...
                    <div class="testimonial-author">
                        <img src="{{url('images/avatars/user-02.jpg')}}" alt="Author image">
                ...
                <div>
                    ...
                    <div class="testimonial-author">
                        <img src="{{url('images/avatars/user-03.jpg')}}" alt="Author image">
                        <div class="author-info">
                            John Doe
